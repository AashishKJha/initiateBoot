package initiateBoot.app.auth.constants;

import initiateBoot.app.common.constants.AppConstants;

public class AuthConstants extends AppConstants {
    public static final int expTime = 20;
